...
const Map1 = () => {
  ...
  return (
    <>
      <div className="map1-bg-section-1 bg-gradient-to-bl from-purple-900 to-indigo-500 ">
        <NavBar />
        {/* Hero Section */}
        <section className="hero-section text-white pb-20">
          ...
          <div className="container mx-auto px-4">
            ...
            <p className="hero-subtitle text-xl mt-4 lg:w-[40vw] md:w-[50vw] sm:w-[80vw]">
              Only by mastering the fundamentals can you elevate your skills to a level where the outcomes become truly legendary.
              So don't rush the process, enjoy the journey, and let your passion for your craft guide you towards achieving your
              full potential.
            </p>
            <motion.button
              className="get-started-btn-master bg-white text-purple-600 font-semibold py-2 px-4 rounded mt-6 transition-colors duration-300"
