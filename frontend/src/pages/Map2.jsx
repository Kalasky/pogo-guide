...
const Map1 = () => {
  ...
  return (
    <>
      <div className="map1-bg-section-1 bg-gradient-to-bl from-blue-400 to-violet-900 ">
        <NavBar />
        {/* Hero Section */}
        <section className="hero-section text-white pb-20">
          ...
          <div className="container mx-auto px-4">
            ...
            <p className="hero-subtitle text-xl mt-4 lg:w-[40vw] md:w-[50vw] sm:w-[80vw]">
              Conquering the hardest climb in the game is no easy feat, but with the right mindset and strategy, you can rise to
              the challenge and achieve the impossible. Prepare yourself for the ultimate test of skill, perseverance, and
              determination, as you embark on a journey that will push you to your limits.
            </p>
            <motion.button
              className="get-started-btn-map2 bg-white text-purple-600 font-semibold py-2 px-4 rounded mt-6 transition-colors duration-300"
