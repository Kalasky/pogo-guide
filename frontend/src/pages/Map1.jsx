...
const Map1 = () => {
  ...
  return (
    <>
      <div className="map1-bg-section-1 bg-gradient-to-bl from-orange-800 to-yellow-400 ">
        <NavBar />
        {/* Hero Section */}
        <section className="hero-section text-white pb-20">
          <div className="container mx-auto px-4">
            ...
            <p className="hero-subtitle text-xl mt-4 lg:w-[40vw] md:w-[50vw] sm:w-[80vw]">
              Remember, every journey begins with a first step, and every victory starts with a small win. So don't be discouraged
              by the obstacles you face, but rather embrace them as opportunities to grow and improve.
            </p>
            <motion.button
              className="get-started-btn-map1 bg-white text-purple-600 font-semibold py-2 px-4 rounded mt-6 transition-colors duration-300"
