...
const Map1 = () => {
  ...
  return (
    <>
      <div className="map1-bg-section-1 bg-gradient-to-bl from-green-300 to-green-600 ">
        <NavBar />
        {/* Hero Section */}
        <section className="hero-section text-white pb-20">
          ...
          <div className="container mx-auto px-4">
            ...
            <p className="hero-subtitle text-xl mt-4 lg:w-[40vw] md:w-[50vw] sm:w-[80vw]">
              The path to legend status is not easy, but the reward is truly legendary. So take the leap, break through your
              limitations, and become the living embodiment of what it means to be a legend!
            </p>
            <motion.button
              className="get-started-btn-legend bg-white text-purple-600 font-semibold py-2 px-4 rounded mt-6 transition-colors duration-300"
